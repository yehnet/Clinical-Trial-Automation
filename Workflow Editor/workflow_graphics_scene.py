...
class WFGraphicsScene (QGraphicsScene):
    ...
    def initAssets(self):
        ...
        self._color_light = QColor("#b2bec3")
    ...
    def drawBackground(self, painter: QPainter, rect: QRect):
        self.mine_1(painter,rect)
    def mine_1(self, painter: QPainter, rect: QRect):
            ...
            for x in range(first_left, right, self.gridSize + 3):
                for y in range(first_top, bottom, self.gridSize + 3):
                    painter.drawEllipse(x, y, 1, 1)
    def mine_2(self, painter: QPainter, rect: QRect):
            ...
            if DEBUG_STATE:
                try:
                    ...
                    dumpException()
    def theirs(self, painter: QPainter, rect: QRect):
            """Draw background scene grid"""
            super().drawBackground(painter, rect)
